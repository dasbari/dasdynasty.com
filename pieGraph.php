...
<html>
    ...
    <body>
        ...
        <div id="MainMenu">
            ...
            <ul>
                ...
                <a href="graph.php"><li>LINE CHART<div class="line"></div></li></a>
            ...
            <div id="title">
  <div class="container">
    <canvas id="myChart" style="padding-top:40px; padding-left:100px;"></canvas>
  </div>
  ...
  <script>
    ...
    <div id="exptotal">
        ...
        <div id="tabExp" style="position:absolute;top:130%;left:50%;transform:translate(-50%,-50%); padding-bottom:20px;">
            <?php
